# Dataset loaders for the PolyU real-image denoising benchmark.
import random
...
class PolyUDataset(Dataset) :
    ...
    def __getitem__(self, index) :
        ...
        # Get Label
        sensor, iso = self.noisy_dataset[0][index].split("_")[0], self.noisy_dataset[0][index].split("_")[3]
    ...
    def get_path_list(self) :            
        noisy_path = join(self.dataroot, "noisy_256")
        clean_path = join(self.dataroot, "clean_256")
        ...
        noisy_name_list = [image_name for image_name in noisy_path_list if ".jpg" in image_name or ".JPG" in image_name]
        clean_name_list = [image_name for image_name in clean_path_list if ".jpg" in image_name or ".JPG" in image_name]
