# Shared image conversion and augmentation helpers.
import math
import random
...
def extract_image_patches(images, ksizes, strides, rates, padding='same'):
    ...
    patches = rearrange(patches, 'N (C k1 k2) L -> (N L) C k1 k2', 
                        N=batch_size, C=channel, k1=ksizes[0], k2=ksizes[1], L=patches.shape[-1])
    return patches
